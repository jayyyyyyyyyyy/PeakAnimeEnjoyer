      ...
      <div className={cn(
        ...
        {saved ? (
          ...
          <div className="flex flex-col items-center py-8">
            ...
            <h2 className="text-2xl font-bold text-white mb-2">Episode Registered!</h2>
            <p className="text-white/60">Your progress has been saved</p>
            <div className="text-4xl mt-4 animate-float">🎉</div>
          </div>
        ) : (
          // Input State
          <>
            ...
            <div className="flex items-center justify-center gap-6 mb-6">
              ...
              <div className="text-center">
                <div className="text-6xl font-black gradient-text">{episode}</div>
                <p className="text-sm text-white/50">Last watched episode</p>
              </div>
            ...
            <div className="glass rounded-2xl p-4 border border-white/10 mb-6">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm text-white/60">Progress Preview</span>
            ...
            <div className="flex items-center gap-3 mb-6 p-3 rounded-xl bg-white/5">
              <div 
                ...
                style={{
                  backgroundImage: "url('https://images.unsplash.com/photo-1578632767115-351597cf2477?w=200&auto=format&fit=crop&q=60')",
                }}
              />
              <div>
                <p className="font-semibold text-white">Frieren</p>
                <p className="text-xs text-white/50">Season #1 • 28 episodes</p>
              </div>
            </div>
